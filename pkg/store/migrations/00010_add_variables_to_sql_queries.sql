...
ALTER TABLE sql_queries ADD COLUMN variables TEXT;
-- +goose StatementEnd
...
INSERT INTO sql_queries_old (id, execution_id, query, normalized_query, query_hash, duration_ms, table_name, operation, rows, explain_plan, created_at, updated_at, deleted_at)
SELECT id, execution_id, query, normalized_query, query_hash, duration_ms, table_name, operation, rows, explain_plan, created_at, updated_at, deleted_at FROM sql_queries;
